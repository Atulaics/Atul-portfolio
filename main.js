...
console.log('%c👋 Welcome to Atul Pandey\'s Portfolio! ', 'color: #00d4ff; font-size: 20px; font-weight: bold;');
console.log('%c🚀 Architect of the Technological Future ', 'color: #0099ff; font-size: 16px;');
console.log('%c💼 Open for opportunities and collaborations! ', 'color: #8892b0; font-size: 14px;');
console.log('%c🔗 LinkedIn: https://www.linkedin.com/in/atulpandeyaics ', 'color: #00d4ff; font-size: 14px;');
